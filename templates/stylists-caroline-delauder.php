<?php $thisPage="stylists"; ?>
		...
		<div class="row">
			<section class="stylists max-9 desktop-9 tablet-6 centered contained">
				<img class="max-5 desktop-5 tablet-3" src="assets/images/stylist-caroline-delauder.jpg" alt="Stylist - Caroline DeLauder">
				<div class="max-7 desktop-7 tablet-3">
					<h1>Caroline DeLauder</h1>
					<p><a href="mailto:caroline@formsalontowson.com">caroline@formsalontowson.com</a></p>
